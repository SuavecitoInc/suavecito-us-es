...
export const responsiveBannerSettings: ResponsiveBannerSectionData = {
  ...
  spread: {
    ...
    reference: {
      ...
      alt: 'Venta de fin de año. 30% de descuento en toda la ropa. Pomada gratis cuando gastas $50!',
      previewImage: {
        url: 'https://cdn.shopify.com/s/files/1/0274/1389/files/dec_30_off_apparel_banner_large_SP.jpg?v=1671670923',
      },
      image: {
        url: 'https://cdn.shopify.com/s/files/1/0274/1389/files/dec_30_off_apparel_banner_large_SP.jpg?v=1671670923',
        width: 2048,
  ...
  mediumSpread: {
    ...
    reference: {
      ...
      alt: 'Venta de fin de año. 30% de descuento en toda la ropa. Pomada gratis cuando gastas $50!',
      previewImage: {
        url: 'https://cdn.shopify.com/s/files/1/0274/1389/files/dec_30_off_apparel_banner_medium_SP.jpg?v=1671670923',
      },
      image: {
        url: 'https://cdn.shopify.com/s/files/1/0274/1389/files/dec_30_off_apparel_banner_medium_SP.jpg?v=1671670923',
        width: 2048,
