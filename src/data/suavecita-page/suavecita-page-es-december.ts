...
export const responsiveBannerSettings: ResponsiveBannerSectionData = {
  ...
  spread: {
    ...
    reference: {
      ...
      alt: 'Compra 1 recibe 1 gratis, en todos los productos de Premium Blends. 50% de descuento en todos los productos de Frida Kahlo. Regalo gratis cuando gastas $55.',
      previewImage: {
        url: 'https://cdn.shopify.com/s/files/1/0274/1389/files/cita_dec_BOGO_landing_banner_large_SP.jpg?v=16710407724',
      },
      image: {
        url: 'https://cdn.shopify.com/s/files/1/0274/1389/files/cita_dec_BOGO_landing_banner_large_SP.jpg?v=1671040772',
        width: 2048,
        height: 930,
      },
    },
  ...
  mediumSpread: {
    ...
    reference: {
      ...
      alt: 'Compra 1 recibe 1 gratis, en todos los productos de Premium Blends. 50% de descuento en todos los productos de Frida Kahlo. Regalo gratis cuando gastas $55.',
      previewImage: {
        url: 'https://cdn.shopify.com/s/files/1/0274/1389/files/cita_dec_BOGO_landing_banner_medium_SP.jpg?v=1671040773',
      },
      image: {
        url: 'https://cdn.shopify.com/s/files/1/0274/1389/files/cita_dec_BOGO_landing_banner_medium_SP.jpg?v=1671040773',
        width: 2048,
