...
export function ProductSectionGetInspired({
  ...
  // @ts-ignore
  const lifesStyleImage1 = selectedVariant?.variantLifestyleImage1;
  // @ts-ignore
  const lifesStyleImage2 = selectedVariant?.variantLifestyleImage2;
  // @ts-ignore
  const lifesStyleImage3 = selectedVariant?.variantLifestyleImage3;
  // @ts-ignore
  const lifesStyleImage4 = selectedVariant?.variantLifestyleImage4;
