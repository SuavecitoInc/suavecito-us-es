...
export function IconMenu({theme = 'suavecito', ...props}: IconProps) {
  const styles = {
    fill:
      theme === 'suavecito'
        ? 'fill-suave-red hover:fill-suave-red-focus'
        : 'fill-suave-pink hover:fill-suave-pink-focus',
  };
  return (
